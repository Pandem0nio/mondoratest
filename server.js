...
function getCardsAttachments(session) {
    return [
        ...
        new builder.ThumbnailCard(session)
            ...
            .buttons([
                builder.CardAction.openUrl(session, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "hai selezionato una card")
