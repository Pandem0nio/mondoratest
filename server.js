...
function getCardsAttachments(session) {
    return [
        ...
        new builder.ThumbnailCard(session)
            ...
            .subtitle('ns to enable natural and contextual interactions')
            ...
            .buttons([
                builder.CardAction.openUrl(session, "http://aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "hai selezionato una card")
