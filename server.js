...
function getCardsAttachments(session) {
    return [
        ...
        new builder.ThumbnailCard(session)
            ...
            .buttons([
                builder.CardAction.postBack(session, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "hai selezionato una card")
